                ...
                ? image == null
                    ...
                    : DecorationImage(
                        ...
                        colorFilter: widget.controller == null
                            ? null
                            : ColorFilter.mode(Colors.black.withOpacity(widget.filterOpacity ?? 0), BlendMode.darken),
                      )
                                    ...
                                    : widget.filledWidget ??
                                        Row(
                                          ...
                                          children: [
                                              ...
                                              GestureDetector(
                                                ...
                                                child: MouseRegion(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: const Icon(Icons.delete_outline, size: 40, color: Colors.white, shadows: [
                                            ...
                                            GestureDetector(
                                              onTap: () => widget.controller?.showImageViewer(context,
                                                  tag: widget.tag,
